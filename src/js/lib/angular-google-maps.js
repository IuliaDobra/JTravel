...
(function () {
        ...
        return {
            figureOutState: function (b, c, d, e, f) {
                ...
                return g = [], h = {}, i = [], _async.each(c.models, function (c) {
                    var f;
                    return null == c[b] ? a.error("id missing for model " + c.toString() + ", can not use do comparison/insertion") : (h[c[b]] = {}, null == d[c[b]] ? g.push(c) : (f = d[c[b]], e(c, f.model) ? void 0 : (g.push(c), i.push(f.model))))
                }, function () {
                    return _async.each(d.values(), function (c) {
                        var d;
                        return null == c ? void a.error("child undefined in ModelsWatcher.") : null == c.model ? void a.error("child.model undefined in ModelsWatcher.") : (d = c.model[b], null == h[d] ? i.push(c.model[b]) : void 0)
                    }, function () {
    ...
    angular.module("google-maps.directives.api.managers").factory("MarkerManager", ["Logger", "FitHelper", function (b, d) {
        ...
        return e = function (e) {
            ...
            return c(f, e), f.include(d), f.prototype.add = function (a, b) {
                ...
                return a = [], this.gMarkers.forEach(function (c) {
                    return c.isDrawn ? void 0 : c.doAdd ? c.setMap(b.gMap) : a.push(c)
    ...
    angular.module("google-maps.directives.api.models.parent").factory("MarkersParentModel", ["IMarkerParentModel", "ModelsWatcher", "PropMap", "MarkerChildModel", "ClustererMarkerManager", "MarkerManager", function (b, d, e, f, g, h) {
        ...
        return i = function (b) {
            function i(b, c, d, f, g) {
                ...
                var h, j = this;
                i.__super__.constructor.call(this, b, c, d, f, g), h = this, this.scope.markerModels = new e, this.$timeout = g, this.$log.info(this), this.doRebuildAll = null != this.scope.doRebuildAll ? this.scope.doRebuildAll : !0, this.setIdKey(b), this.scope.$watch("doRebuildAll", function (a, b) {
            ...
            return c(i, b), i.include(d), i.prototype.onTimeOut = function (a) {
                ...
                return null != this.scope.models && this.scope.models.length > 0 && this.scope.markerModels.length > 0 ? this.figureOutState(this.idKey, a, this.scope.markerModels, this.modelKeyComparison, function (c) {
                    ...
                    return d = c, _async.each(d.removals, function (a) {
                        return null != a ? (a.destroy(), b.scope.markerModels.remove(a.id)) : void 0
                    }, function () {
                        return _async.each(d.adds, function (c) {
                            return b.newChildMarker(c, a)
                        }, function () {
                            return b.gMarkerManager.draw(), a.markerModels = b.scope.markerModels
                        })
                    })
        ...
        return h = function (b) {
            function h(b, c, d, f, i, j, k, l, m) {
                ...
                this.$interpolate = m, this.interpolateContent = a(this.interpolateContent, this), this.setChildScope = a(this.setChildScope, this), this.createWindow = a(this.createWindow, this), this.setContentKeys = a(this.setContentKeys, this), this.pieceMealWindows = a(this.pieceMealWindows, this), this.createAllNewWindows = a(this.createAllNewWindows, this), this.watchIdKey = a(this.watchIdKey, this), this.createChildScopesWindows = a(this.createChildScopesWindows, this), this.watchOurScope = a(this.watchOurScope, this), this.watchDestroy = a(this.watchDestroy, this), this.rebuildAll = a(this.rebuildAll, this), this.doINeedToWipe = a(this.doINeedToWipe, this), this.watchModels = a(this.watchModels, this), this.watch = a(this.watch, this), h.__super__.constructor.call(this, b, c, d, f, i, j, k, l), n = this, this.windows = new e, this.scopePropNames = ["show", "coords", "templateUrl", "templateParameter", "isIconVisibleOnClick", "closeClick"], _.each(this.scopePropNames, function (a) {
                    ...
                    return o.watchOurScope(b), o.doRebuildAll = null != o.scope.doRebuildAll ? o.scope.doRebuildAll : !0, b.$watch("doRebuildAll", function (a, b) {
            ...
            return c(h, b), h.include(d), h.prototype.watch = function (a, b, c) {
                ...
                return null == c && (c = "models"), null == d && (d = !0), this.models = a.models, null != a && null != a.models && a.models.length > 0 && this.windows.length > 0 ? this.figureOutState(this.idKey, a, this.windows, this.modelKeyComparison, function (b) {
                    ...
                    return d = b, _async.each(d.removals, function (a) {
                        return null != a ? (a.destroy(), e.windows.remove(a.id)) : void 0
                    }, function () {
    ...
    angular.module("google-maps.directives.api").factory("Map", ["$timeout", "Logger", "GmapUtil", "BaseObject", function (b, d, e, f) {
        ...
        return g = d, h = {mapTypeId: google.maps.MapTypeId.ROADMAP}, i = function (b) {
            ...
            return c(d, b), d.include(e), d.prototype.restrict = "ECMA", d.prototype.transclude = !0, d.prototype.replace = !1, d.prototype.template = '<div class="angular-google-map"><div class="angular-google-map-container"></div><div ng-transclude style="display: none"></div></div>', d.prototype.scope = {
                center: "=center",
                zoom: "=zoom",
                dragging: "=dragging",
                control: "=",
        ...
        return g = function (a) {
            ...
            link: function (h, i, j, k) {
                return angular.isUndefined(h.bounds) || null === h.bounds || angular.isUndefined(h.bounds.sw) || null === h.bounds.sw || angular.isUndefined(h.bounds.ne) || null === h.bounds.ne || !g(h.bounds) ? void a.error("rectangle: no valid bound attribute found") : b(function () {
                    ...
                    return b = function (a) {
                        var b;
                        return b = angular.extend({}, c, {
                            map: i,
                            bounds: a,
                            strokeColor: h.stroke && h.stroke.color,
                            strokeOpacity: h.stroke && h.stroke.opacity,
                            strokeWeight: h.stroke && h.stroke.weight,
                            fillColor: h.fill && h.fill.color,
                            fillOpacity: h.fill && h.fill.opacity
                        }), angular.forEach({clickable: !0, draggable: !1, editable: !1, visible: !0}, function (a, c) {
                        ...
                        return a = l.getBounds(), b = a.getNorthEast(), c = a.getSouthWest(), m ? void 0 : _.defer(function () {
                            return h.$apply(function (a) {
                                l.dragging || null !== a.bounds && void 0 !== a.bounds && void 0 !== a.bounds && (a.bounds.ne = {
                                    latitude: b.lat(),
                                    longitude: b.lng()
    ...
    angular.module("google-maps").directive("layer", ["$timeout", "Logger", "LayerParentModel", function (b, c, d) {
        ...
        return new (e = function () {
            function b(b) {
                this.$timeout = b, this.link = a(this.link, this), this.$log = c, this.restrict = "ECMA", this.require = "^googleMap", this.priority = -1, this.transclude = !0, this.template = '<span class="angular-google-map-layer" ng-transclude></span>', this.replace = !0, this.scope = {
                    show: "=show",
                    type: "=type",
                    namespace: "=namespace",
                    options: "=options",
